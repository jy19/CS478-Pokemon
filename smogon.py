...
class Smogon:
    ...
    def get_pokemon_info(self, pokemon):
        moveset_fields = ["name", "alias", {"movesets": ["name",
                                                         ...
                                                         {"$groupby": "slot",
                                                          "moveslots": ["slot", {"move": ["name", "alias", "gen"]}]},
                                                         "description"]},
                          {"moves": ["name", "alias", "gen", "category", "power", "accuracy", "pp", "description",
                                     {"type": ["alias", "name", "gen"]}]}
                          ]
        ...
        meta_fields = ["name", "alias", "gen", {"types": ["alias", "name", "gen"]},
                       {"abilities": ["alias", "name", "gen"]}, "hp", "patk", "pdef", "spatk", "spdef", "spe"]
...
class SmogonPokemon():
    ...
    def to_dict(self):
        dictionary = {'name': self.name, 'typing': self.typing, 'stats': self.stats,
...
class SmogonMoveset():
    ...
    def to_dict(self):
        dictionary = {'name': self.name, 'item': self.item, 'ability': self.ability, 'evs': self.evs,
                      'nature': self.nature, 'moves': self.moves, 'tag': self.tag}
        return dictionary

    @staticmethod
    def from_dict(dictionary):
        return SmogonMoveset(dictionary['name'], dictionary['item'], dictionary['ability'], dictionary['evs'],
                             dictionary['nature'], dictionary['moves'], dictionary['tag'])
